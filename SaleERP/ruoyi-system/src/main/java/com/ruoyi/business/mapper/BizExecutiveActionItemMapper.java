 ...
 * @date 2026-04-12
 */
public interface BizExecutiveActionItemMapper
{
    /**
     * 查询经营决议事项
     * 
     ...
     * @return 结果
     */
    public int insertBizExecutiveActionItem(BizExecutiveActionItem bizExecutiveActionItem);
     ...
     * @return 结果
     */
    public int updateBizExecutiveActionItem(BizExecutiveActionItem bizExecutiveActionItem);
