...
public class BizReportServiceImpl implements IBizReportService
{
    ...
    public AjaxResult getDashboardData()
    {
        ...
        ajaxResult.put("riskOverview", getRiskOverviewData());
     ...
     * @return 风险概览数据
     */
    private Map<String, Object> getRiskOverviewData()
    {
        ...
        riskOverviewMap.put("stockWarningCount", nvlCount(bizReportMapper.selectStockWarningCount()));
