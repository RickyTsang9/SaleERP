  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch">
      <el-form-item label="出库单编号" prop="outboundId">
        <el-input v-model="queryParams.outboundId" placeholder="请输入出库单编号" clearable style="width: 220px" @keyup.enter="handleQuery" />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="Plus" @click="handleAdd" v-hasPermi="['business:outboundItem:add']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="success" plain icon="Edit" :disabled="single" @click="handleUpdate" v-hasPermi="['business:outboundItem:edit']">修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" plain icon="Delete" :disabled="multiple" @click="handleDelete" v-hasPermi="['business:outboundItem:remove']">删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning" plain icon="Download" @click="handleExport" v-hasPermi="['business:outboundItem:export']">导出</el-button>
      </el-col>
    ...
    <el-dialog :title="title" v-model="open" width="760px" append-to-body>
      <el-form ref="outboundItemRef" :model="form" :rules="rules" label-width="110px">
        <el-row>
          <el-col :span="12">
            <el-form-item label="出库单编号" prop="outboundId">
              <el-input-number v-model="form.outboundId" :min="1" controls-position="right" style="width: 100%" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="商品编号" prop="productId">
...
<script setup name="BusinessOutboundItem">
...
function handleSelectionChange(selection) {
  ids.value = selection.map(item => item.outboundItemId)
...
function handleUpdate(row) {
  reset()
  const outboundItemId = row.outboundItemId || ids.value
...
function handleDelete(row) {
  const outboundItemIds = row.outboundItemId || ids.value
...
function handleExport() {
  proxy.download("business/outboundItem/export", {
    ...queryParams.value
  }, `outbound_item_${new Date().getTime()}.xlsx`)
}
